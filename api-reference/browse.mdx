...
Discovery includes a **`browser`** block in [`GET /v1/capabilities`](https://lithtrix.ai/v1/capabilities). Successful JSON includes **`_lithtrix.browse_url`**. **Browse is metered per call, 3–5 credits ($0.03–$0.05), from the very first call** — no free floor, no pack requirement (D173).
