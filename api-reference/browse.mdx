...
Discovery includes a **`browser`** block in [`GET /v1/capabilities`](https://lithtrix.ai/v1/capabilities). Successful JSON includes **`_lithtrix.browse_url`**. **Browse has a rolling-30 free floor of 20 calls on trial**; past the floor, **static 3 credits ($0.03)** / **dynamic 5 credits ($0.05)** per call (D173/D174). No pack purchase required.
