...
Returns a Stripe Checkout URL — open it to complete payment. On success, credits are granted immediately via webhook and pack expiry is set to **180 days from grant (UTC)**.
