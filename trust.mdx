...
7. **[Agent freeze](/concepts/agent-freeze)** — in-place kill switch (`POST /v1/me/freeze`, root key).
8. **[Policy bindings](/concepts/policy-bindings)** — signed `tool_allow_list` on delegation create.
9. **[Action trail](/concepts/action-trail)** — export `task_trace_events` across your delegations.
