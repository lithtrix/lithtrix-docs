...
Discover canonical URLs on **`GET /v1/capabilities`** version **`4.4.0`** under **`commons`** (`read_list_url`, **`commons_search`**, `read_one_url_template`, vouch URL templates, `delete_url_template`, **`vouching`**, optional **`mcp_tool_definition`**).
